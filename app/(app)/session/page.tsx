          ...
          <div style={{ display: 'grid', gridTemplateColumns: '1fr 2fr', gap: '1.5rem', alignItems: 'start' }}>
            ...
            <div style={{ display: 'flex', flexDirection: 'column', gap: '1rem' }}>
              ...
              {fomoLocked ? (
                ...
                <button className="trade-new-btn" onClick={openChecklist} style={{ background: 'linear-gradient(135deg,#6366F1,#8B5CF6)', color: '#fff', border: 'none', borderRadius: '16px', padding: '1.625rem 2rem', fontSize: '1.125rem', fontWeight: 700, cursor: 'pointer', display: 'flex', alignItems: 'center', justifyContent: 'center', gap: '0.75rem', boxShadow: '0 0 32px rgba(99,102,241,0.4)', transition: 'opacity 0.2s,transform 0.15s', width: '100%' }}>
